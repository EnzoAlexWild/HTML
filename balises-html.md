...
```html
<a href="https://ludo.fr">Site personnel de Ludo</a>
...
<a href="mailto:ludo@mails.com">Envoyer un e-mail</a>
```
...
```html
<p>Lorsque est sorti le jeu <em>24cr</em>, il a été <strong>vendu à plus de 15 millions d'exemplaires</strong>. Les gens ont particulièrement apprécié le gameplay.</p>
```
...
> ⛔ Ces balises ne sont plus à utiliser
